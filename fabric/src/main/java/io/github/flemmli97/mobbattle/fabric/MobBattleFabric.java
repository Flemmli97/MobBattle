...
public class MobBattleFabric implements ModInitializer {
    ...
    public static void registerPackets() {
        ...
        PayloadTypeRegistry.serverboundPlay().register(C2SPerimeterComponent.TYPE, C2SPerimeterComponent.STREAM_CODEC);
        ...
        PayloadTypeRegistry.clientboundPlay().register(S2CPerimeterInfo.TYPE, S2CPerimeterInfo.STREAM_CODEC);
        if (FabricLoader.getInstance().getEnvironmentType() == EnvType.CLIENT) {

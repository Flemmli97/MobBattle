...
public class LibTags {
    ...
    public static final String spawnEggTag = MobBattle.MODID + ":Entity";
    public static final String savedEntity = MobBattle.MODID + ":StoredEntity";
    public static final String savedEntityName = MobBattle.MODID + ":StoredEntityName";

...
public class MobArmy extends Item{
	...
	public void addInformation(ItemStack stack, World world, List<ITextComponent> list, ITooltipFlag b) 
	{
		...
		list.add(new TextComponentString(TextFormatting.AQUA + "Right click into air to to add entities in the box to the team with the name of this item (if exists, else DEFAULT)"));
		list.add(new TextComponentString(TextFormatting.AQUA + "Shift-Right click to reset box"));
		list.add(new TextComponentString(TextFormatting.AQUA + "Left click to add entities to the team with the name of this item (if exists, else DEFAULT)"));
	}

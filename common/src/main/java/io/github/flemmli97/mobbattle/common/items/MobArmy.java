...
public class MobArmy extends Item implements ExtendedItem {
    ...
    public void appendHoverText(ItemStack stack, Item.TooltipContext ctx, TooltipDisplay display, Consumer<Component> adder, TooltipFlag flag) {
        adder.accept(Component.translatable("tooltip.mobbattle.army.first").withStyle(ChatFormatting.AQUA));
        adder.accept(Component.translatable("tooltip.mobbattle.army.second").withStyle(ChatFormatting.AQUA));
        adder.accept(Component.translatable("tooltip.mobbattle.army.third").withStyle(ChatFormatting.AQUA));
        adder.accept(Component.translatable("tooltip.mobbattle.army.forth").withStyle(ChatFormatting.AQUA));
    }
    ...
    public InteractionResult use(Level world, Player player, InteractionHand hand) {
        ...
        if (player instanceof ServerPlayer serverPlayer && stack.has(MobBattleDataComponents.BOX.get())) {

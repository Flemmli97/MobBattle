...
public class MobEffectGive extends ItemSword{
	...
	public MobEffectGive()
	{
        ...
        GameRegistry.register(this, new ResourceLocation(MobBattle.MODID, "mob_effect_give"));	
    }
	...
	@Override
	public void addInformation(ItemStack stack, EntityPlayer player, List<String> list, boolean flagIn) {
		...
		if(entity instanceof EntityLivingBase)
		{
			...
			if(stack.hasTagCompound())
			{
				...
				if(potion!=null)
				{
					...
					{
						player.addChatMessage(new TextComponentString(TextFormatting.GOLD + "Added effect " + potionString + " "+amplifier + " for " + duration + " ticks "));
					}
				}
			}
		}

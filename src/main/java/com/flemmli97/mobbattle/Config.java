...
public class Config {
    ...
    {
    	public final BooleanValue showTeamParticles;
    	
		public ClientConfig(ForgeConfigSpec.Builder builder) {
			builder.push("general");
			showTeamParticles = builder
	            .translation("conf.mobbattle.particle")
    ...
    public static class ServerConfig
    {
		...
		public ServerConfig(ForgeConfigSpec.Builder builder) {
			autoAddAI = builder
				.comment("Auto target mobs from other teams (if e.g. done per command)")
	            .translation("conf.mobbattle.addai")

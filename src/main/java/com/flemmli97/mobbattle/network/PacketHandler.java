...
public class PacketHandler {
	...
	public static void register()
	{
		...
		dispatcher.registerMessage(id++,PacketOpenGuiArmor.class, PacketOpenGuiArmor::toBytes, PacketOpenGuiArmor::fromBytes, PacketOpenGuiArmor::onMessage);
	...
	public static final <T> void sendToClient(T message, EntityPlayerMP player) {

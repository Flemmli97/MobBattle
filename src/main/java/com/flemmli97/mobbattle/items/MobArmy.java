...
public class MobArmy extends ItemSword {
    ...
    public ActionResult<ItemStack> onItemRightClick(World world, EntityPlayer player, EnumHand hand) {
        ...
        if(stack.getMetadata() == 0){
            if(player.isSneaking() && stack.hasTagCompound()){
                ...
                BlockPos pos1 = new BlockPos(stack.getTagCompound().getIntArray("Position1")[0], stack.getTagCompound().getIntArray("Position1")[1],
                        stack.getTagCompound().getIntArray("Position1")[2]);
                BlockPos pos2 = new BlockPos(stack.getTagCompound().getIntArray("Position2")[0], stack.getTagCompound().getIntArray("Position2")[1],
                        stack.getTagCompound().getIntArray("Position2")[2]);
    ...
    public void initModel() {
        for(int i = 0; i < 4; i++)
            ModelLoader.setCustomModelResourceLocation(this, i, new ModelResourceLocation(this.getRegistryName() + "_" + i, "inventory"));
    }
}

...
public class ModComponents {
    ...
    public static DataComponentType<SpawnEggOptions> SPAWN_EGG_OPTIONS;
    ...
    public static void register() {
        ...
        SPAWN_EGG_OPTIONS = register("spawnegg_options", new DataComponentType.Builder<SpawnEggOptions>().persistent(SpawnEggOptions.CODEC).networkSynchronized(SpawnEggOptions.STREAM_CODEC).build());
    }

...
public class EntityAIItemPickup extends EntityAIBase
{
    ...
    public boolean shouldExecute()
    {
        ...
        {
            List<EntityItem> list = this.entity.world.<EntityItem>getEntitiesWithinAABB(EntityItem.class, this.entity.getBoundingBox().grow(8));
            if (list.isEmpty())
            {
                return false;
            }
	...
	@Override
	public void tick() {
		for (EntityItem entityitem : this.entity.world.getEntitiesWithinAABB(EntityItem.class, this.entity.getBoundingBox().grow(1.0D, 0.0D, 1.0D)))
        {

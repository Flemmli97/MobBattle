	...
	public int getColor(ItemStack stack, int tintIndex)
    {
		...
		if(id!=null)
		{
			...
			if(eggInfo==null && CommonProxy.mca)
			{
				...
				{
					int i = stack.getTag().getCompound(ItemExtendedSpawnEgg.tagString).contains("GENDER")?stack.getTag().getCompound(ItemExtendedSpawnEgg.tagString).getInteger("GENDER"): 
						stack.getTag().getCompound(ItemExtendedSpawnEgg.tagString).contains("MCAGender")?stack.getTag().getCompound(ItemExtendedSpawnEgg.tagString).getInteger("MCAGender"):0;
